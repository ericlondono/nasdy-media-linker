...
def build_plan(media_type: str, source: str, title: str, year: str, season: str):
    ...
    items = []
    # v3.6.1.8: even when a row arrives as TV, a direct folder of movie files
    ...
    if media_type == "tv":
        # v3.6.1.8: TV source folders can contain multiple seasons and episode titles.
        ...
        # v3.6.1.8: a TV-heavy pack can include a direct folder of movie files.
